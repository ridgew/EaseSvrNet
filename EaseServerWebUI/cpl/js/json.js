...
var result=eval('('+text+')');return typeof reviver==='function'?walk({'':result},''):result;},parse:function(text){var at=0,ch=' ',result,value;function error(m){var e=new SyntaxError(m);e.at=at-1;e.text=text;throw e;}
