...
$(document).ready(function() {
    ...
    $('#aReset').click(function() {
        $('.listIB input.inp02').not('#txtUserName').not('#txtLastLockedOutDate').val('');
        $('#txtComment').val('');
    });
    ...
    $('#aSave').click(function() {
        ...
        var currentUserId;
        var IsOneself=true;
        var delAjax = new top.AJAXFunction({ url: './service/1.3.5.3.9', param: {} });
        delAjax.SuFun = function(json) {
            currentUserId=json.d.UserId;
    ...
    $("#txtUserName").parent().parent().hide();
    $("#chkbxApproved_0").parent().parent().hide();
    $("#chkbxApproved_1").parent().parent().hide();
    $("#chkbxLockedOut_0").parent().parent().hide();
    $("#chkbxLockedOut_1").parent().parent().hide();
    $("#txtLastLockedOutDate").parent().parent().hide();
    $('#roleList').parent().hide();
